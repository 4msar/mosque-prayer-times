...
export default function MosqueDetailsScreen({
    ...
    const { name = route.params.name, formatted_address: address } =
        mosque || {};
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const mosqueData = {
                ...
                longitude:
                    mosque.geometry.location.lng || route.params.longitude,
                prayerTimes: {
    ...
    const handleLinkOpen = () => {
        if (mosque?.url) {
            Linking.openURL(mosque.url).catch((err) =>
    ...
    const PrayerDisplay = ({
        ...
        label: string;
        field: keyof typeof prayerTimes;
    }) => (
        <View style={styles.displayRow}>
            <Text style={styles.displayLabel}>{label}</Text>
            <Text style={styles.displayValue}>
                {prayerTimes[field] || "Not set"}
            </Text>
        </View>
    );
